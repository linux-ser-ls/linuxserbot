...
_🤖 Please make the bot an admin first_

_📌 Required for this feature to work_
...
_👮 Only group admins can use the kick command_

_📌 You don’t have required privileges_
...
_👤 Please mention a user or reply to their message to kick_

_📌 Example: .kick @user_
...
_🌷 Try again ✨_
    ...
    try {
        ...
        await sock.sendMessage(chatId, { 
            text: `_ ✅ ${usernames.join(', ')} has been Kicked Successfully!_`,
            mentions: usersToKick
        });
    } catch (error) {
        console.error('Error in kick command:', error);
        await sock.sendMessage(chatId, { 
            text: '_❌ Failed to kick user(s)!_'
        });
    }
}
