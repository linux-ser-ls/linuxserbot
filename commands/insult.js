const insults = [
    "☁️ You're like a cloud. When you disappear, it's a beautiful day!",
    ...
    "☁️ You're like a cloud. Always floating around with no real purpose.",
    "🥛 Your jokes are like expired milk—sour and hard to digest.",
    "🕯️ You're like a candle in the wind... useless when things get tough.",
    ...
    "🕳️ Your energy is like a black hole—it sucks the life out of the room.",
    "📻 You have the perfect face for radio.",
    "🚦 You're like a traffic jam—nobody wants you, but here you are.",
    "✏️ You're like a broken pencil—pointless.",
    "💡 Your ideas are so original, I'm sure I've heard them all before.",
    "🛠️ You're living proof that even mistakes can be productive.",
    ...
    "🗣️ You bring people together... to talk about how annoying you are."
];
...
_❌ Please mention a user_
_👤 or reply to their message_

_📌 Example: .insult @user_

_🌷 Tag someone to continue ✨_`
    });
    return;
}
